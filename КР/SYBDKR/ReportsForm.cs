...
namespace SYBDKR
{
    public partial class ReportsForm : Form
    {
        ...
        private void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"Произошла ошибка при генерации отчетов: {ex.Message}", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void GenerateSalesQuantityReport()
        {
            ...
            {
                MessageBox.Show($"Ошибка при генерации отчета о количестве продаж: {ex.Message}", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void GenerateSalesRevenueReport()
        {
            ...
            {
                MessageBox.Show($"Ошибка при генерации отчета о выручке от продаж: {ex.Message}", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
